                    ...
                    items: [
                        {
                            ...
                            itemId: 'preview',
                            autoEl: {
                                        html  :'<div class="accordionwidget" style="width: 97%;box-shadow: 0 -40px 80px -80px rgba(0,0,0,0.5) inset;padding: 10px;border-radius: 12px;border: 1px solid #ccc;position: relative;"><div class="row"><div class="titleimg" style="width:80%;float:left;"><img style="display:none; src="" alt="icon-img" class="left tile" style="height:40px;width:50px;/></div>'+
                                        '<div class="" style="width:70%;float:left"><h3 class="heading" style="display:none;padding: 12px 20px 20px;vertical-align: top;">Title</h3></div> <div class="toggleimg" style="width:20%;float:right;"><img style="display:none; src=""/ alt="+"></div><div style="clear:both;"></div></div>'+
                                        '<div class="row"><div class="rightaccordiondiv description" style="float:right;width:40%;">{{model.config.content|safe}}</div>'+
                                        '<div class="lefaccordiondiv" style="float:left;width:40%;"><h4 style="display:none; class="title1">asfaqwerqwrqwerqwerqwerqwerqwer</h4><h5 style="display:none; class="title2">qwerqwerqwerq</h5>'+
                                        '<img src="../resources/images/icons/extra-icons/val_InStyle2.jpg" width="133" border="0" alt="imgsrc" class="imgSrcValue" /></div></div><div style="clear:both;"></div></div>'
                                    }
                        }
                    ] 
                },
