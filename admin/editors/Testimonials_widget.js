...
Ext.widget({
    ...
    items: [
                    ...
                    items: [
                        {
                            ...
                            itemId: 'preview',
                            autoEl: {
                                        html  :'<div class="accordionwidget" style="width: 97%;box-shadow: 0 -40px 80px -80px rgba(0,0,0,0.5) inset;padding: 10px;border-radius: 12px;border: 1px solid #ccc;position: relative;"><div class="row"><h2 style="text-align:center;">Preview</h2>'+
                                        '<div class="" style="width:70%;float:left"><h3 class="heading" style="display:inline-block;padding: 12px 20px 20px;vertical-align: top;">Title</h3></div> <div style="clear:both;"></div></div>'+
                                        '<div class="row"><div class="rightaccordiondiv description" style="float:right;width:40%;">{{model.config.content|safe}}</div>'+
                                        '<div class="lefaccordiondiv" style="float:left;width:40%;"><h4 class="title1"></h4><h5 class="title2"></h5>'+
				...
				{
                    xtype: 'checkbox',
                    fieldLabel: 'View More Testimonails Link',
                    name: 'link',
                    width: 500
                }
    ],
