...
(function (f, c) {
	...
	e.prototype.destroyIt = function () {
		var a = this;
		a.el = new h(a.element);
		a.el.j.unwrap(); 
		a.rt = new h(a.el.j.parent());
		a.rt.j.find('.sxy-zoom-bg,.sxy-controls,.sxy-zoom-dragpad,.sxy-loading').remove();
	};
    e.prototype.tearUp = function () {
        ...
        a.element.hide();
        a.rt = new h(a.el.j.parent());
        a.rt.j.append('<img class="sxy-zoom-bg" src="{srcthumb}" /><div class="sxy-controls"><div class="overlay"></div><a class="in" href="#"></a><div class="sxy-slider"><div class="sxy-handle" style="top: 0px;"></div></div><a class="out" href="#"></a></div><div class="sxy-zoom-dragpad"><div class="sxy-overlay"></div><div class="sxy-zoom-viewport"><img galleryimg="no" /></div><img class="inner-thumb" src="{srcthumb}" /><div class="sxy-zoom-viewfinder"></div></div><div class="sxy-loading"><span></span></div>'.replace(/\{(\w+)\}/g,
            function (a, b) {
                return e[b] || a
            }));
...
(function (f, c) {
    ...
    f.fn.swinxyzoom.modes.dock = function (a) {
		...
		var ZPWV = f.extend({}, ZPW, a.options.portDim);
