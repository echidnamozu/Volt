...
s_a[239]="Alabama|Alaska|Alberta|Arizona|Arkansas|British Columbia|California|Colorado|Connecticut|Delaware|District of Columbia|Florida|Georgia|Hawaii|Idaho|Illinois|Indiana|Iowa|Kansas|Kentucky|Louisiana|Maine|Manitoba|Maryland|Massachusetts|Michigan|Minnesota|Mississippi|Missouri|Montana|Nebraska|New Brunswick|Nevada|New Hampshire|Newfoundland and Labrador|New Jersey|New Mexico|New York|North Carolina|North Dakota|Northwest Territories|Nova Scotia|Nunavut|Ohio|Oklahoma|Ontario|Oregon|Pennsylvania|Prince Edward Island|Quebec|Rhode Island|Saskatchewan|South Carolina|South Dakota|Tennessee|Texas|Utah|Vermont|Virginia|Washington|West Virginia|Wisconsin|Wyoming|Yukon Territory";
...
function populateStates( countryElementId, stateElementId, selindex ){

		var selectedCountryIndex = document.getElementById( countryElementId ).selectedIndex;
	
	if(selindex!=="")
		selectedCountryIndex = selindex;
