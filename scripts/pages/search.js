...
define(['modules/jquery-mozu', "underscore", 'hyprlive', "modules/views-collections","modules/models-faceting",'modules/cart-monitor', 'modules/modal', 'modules/api', 'modules/models-cart', 'modules/models-product',
