    ...
    "modules/backbone-mozu-model"], function ($, _, Hypr, Backbone) {
        ...
        var PagedCollection = Backbone.MozuPagedCollection = Backbone.MozuModel.extend({
            ...
            myAccountChangePageSize: function() {
                return this.apiGet($.extend(this.lastRequest, { pageSize: this.get('pageSize'), filter: "Status ne Created and Status ne Validated and Status ne Abandoned and Status ne Errored and Status ne Pending", sortBy:"orderNumber desc"}));
            },
            lastIndex: function() {
